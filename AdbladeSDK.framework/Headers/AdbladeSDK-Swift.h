...
///
/// <ul><li>native:<ul><li>298x224 image</li><li>title</li><li>description</li><li>display name</li></ul></li><li>mediumRectangle: 300x250</li><li>richMediaMediumRectangle: 300x250 Rich Media</li><li>leaderboard: 728x90</li><li>richMediaLeaderboard: 728x90 Rich Media</li><li>banner: 320x50</li><li>mediumBanner: 320x100</li><li>fullBanner: 468x60</li><li>slideshow - a collection of the other ad types that can be rotated through</li></ul>
...
@property (nonatomic, copy) NSArray<NSNumber *> * __nonnull adTypes;
...
/// The AdViewDelegate the view will use if the implementing app wants to track Adblade's events. This is optional.
@property (nonatomic, strong) id <AdbladeDelegate> __nullable delegate;
...
/// The AdbladeDelegate the view will use if the implementing app wants to track Adblade's events. This is optional.
@property (nonatomic, strong) id <AdbladeDelegate> __nullable delegate;
...
/// This can be used if you want to track any events during the process. All methods are optional and you only have to implement what you need.
///
...
/// //...
///
/// <code>func didReceiveAd(view: AdbladeView) {
///     //...
/// }
/// 
/// </code>
...
/// This executes immediately before the user leaves your application. This will be run when a tap event occurs on an ad.
///
/// :param: view The AdbladeView that the ad will be shown in.
...
/// The implementation of AdbladeView that handles interstitial ads. This is a subclass of AdbladeBannerView.
...
@property (nonatomic, readonly, strong) UIButton * __nullable closeButton;
...
/// This is called when each element (e.g. title) of the native ad is added to the AdbladeView.
///
...
@interface AdbladeViewFactory : NSObject
...
///
/// <ul><li>banner: allowed ad types<ul><li>banner</li><li>mediumBanner</li><li>fullBanner</li></ul></li><li>interstitial: allowed ad types<ul><li>mediumRectangle</li><li>leaderboard</li><li>slideshow</li></ul></li><li>native<ul><li>native</li></ul></li></ul>
